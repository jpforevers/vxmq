...
public class ShellCmdConstants {
  ...
  public static final String COMMAND_WILL = "will";
  public static final String COMMAND_RETAIN = "retain";
  public static final String COMMAND_SUB = "sub";
  public static final String COMMAND_INBOUNDQOS2PUB = "inboundQos2Pub";
  public static final String COMMAND_OUTBOUNDQOS1PUB = "outboundQos1Pub";
  public static final String COMMAND_OUTBOUNDQOS2PUB = "outboundQos2Pub";
  public static final String COMMAND_OUTBOUNDQOS2REL = "outboundQos2Rel";
