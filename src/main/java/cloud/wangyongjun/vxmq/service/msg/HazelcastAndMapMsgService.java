...
public class HazelcastAndMapMsgService implements MsgService {

  private static volatile HazelcastAndMapMsgService hazelcastAndMapMsgService;

  public static HazelcastAndMapMsgService getSingleton(Vertx vertx) {
    if (hazelcastAndMapMsgService == null) {
      synchronized (HazelcastAndMapMsgService.class) {
        if (hazelcastAndMapMsgService == null) {
          hazelcastAndMapMsgService = new HazelcastAndMapMsgService(vertx);
        }
      }
    }
    return hazelcastAndMapMsgService;
  }
  ...
  private HazelcastAndMapMsgService(Vertx vertx) {
    this.vertx = vertx;
